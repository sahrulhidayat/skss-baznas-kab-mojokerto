        ...
        <ul className="px-8 timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            ...
            <div className="text-sm timeline-start mb-10 md:text-end">
              <time className="text-sm md:text-lg font-mono italic">
                10-14 Maret 2025
              </time>
              <div className="text-sm md:text-lg font-black">
                Pasar Murah Ramadhan
              </div>
              Membantu BAZNAS Kabupaten Mojokerto untuk melaksanakan acara Pasar
              Murah Ramadhan. Acara ini bertujuan untuk membantu masyarakat yang
              membutuhkan dalam memenuhi kebutuhan pokok selama bulan Ramadhan
            </div>
            <hr />
          </li>
          <li>
            ...
            <div className="timeline-end mb-10">
              ...
              Kami memberdayakan sedekah dari pengusaha warung makanan berupa
              sejumlah makanan dan kotak nasi sekitar dan membagikannya kepada
